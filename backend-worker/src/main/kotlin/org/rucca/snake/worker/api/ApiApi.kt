...
interface ApiApi {
            ...
            [
                ApiResponse(
                    ...
                    content =
                        [
                            Content(
                                schema = Schema(implementation = ApiExecPost200ResponseDTO::class)
                            )
                        ]
                ),
                ApiResponse(
                    ...
                    content =
                        [
                            Content(
                                schema = Schema(implementation = ApiExecPost400ResponseDTO::class)
                            )
                        ]
                )
            ]
    ...
    fun apiExecPost(
        ...
        @Valid
        @RequestBody
        apiExecPostRequestDTO: ApiExecPostRequestDTO
    ): ResponseEntity<ApiExecPost200ResponseDTO> {
            ...
            [
                ApiResponse(
                    ...
                    content =
                        [
                            Content(
                                schema = Schema(implementation = ApiSubmitPost200ResponseDTO::class)
                            )
                        ]
                ),
                ApiResponse(
                    ...
                    content =
                        [
                            Content(
                                schema = Schema(implementation = ApiSubmitPost400ResponseDTO::class)
                            )
                        ]
                ),
                ApiResponse(
                    ...
                    content =
                        [
                            Content(
                                schema = Schema(implementation = ApiSubmitPost403ResponseDTO::class)
                            )
                        ]
                )
            ]
    ...
    ): ResponseEntity<ApiSubmitPost200ResponseDTO> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
}
